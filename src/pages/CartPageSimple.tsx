                ...
                <div className="flex min-h-full items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-4 mb-8">
                            {/* Time Block */}
                            <div className="bg-gray-50/50 p-4 rounded-3xl border border-gray-100 flex items-center justify-center">
                            ...
                            <div className="bg-gray-50/50 p-6 rounded-3xl border border-gray-100">
                                <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-4 text-center">
                                ...
                                {orderWhatsappUrl && (
                                    <a
                                        ...
                                        className="w-full mb-6 bg-[#25D366] text-white px-8 py-4 rounded-2xl font-black text-sm hover:bg-[#1ebd59] transition-all shadow-xl shadow-green-100 transform active:scale-90 flex items-center justify-center gap-2 no-underline"
                                    >
                        ...
                        <div className="bg-white md:rounded-xl shadow-[0_4px_10px_rgba(0,0,0,0.03)] md:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)] px-3 py-5 md:p-6 mx-0 md:mx-0 rounded-[28px] md:rounded-xl">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="mt-8 pt-6 border-t border-gray-100">
                                    <h2 className="text-lg md:text-xl font-bold mb-4 flex items-center gap-2">
                                        <CreditCard size={18} strokeWidth={1.5} className="text-red-600" />
                                        Método de Pago
                                    </h2>
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                ...
                                <div className="mt-8 pt-6 border-t border-gray-100">
                                    <h2 className="text-lg md:text-xl font-bold mb-4 flex items-center gap-2">
                                        <Smartphone size={18} strokeWidth={1.5} className="text-red-600" />
                                        Datos de contacto
                                    </h2>
