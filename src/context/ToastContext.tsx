...
const ToastContainer: React.FC<{ toasts: Toast[]; removeToast: (id: string) => void }> = ({
    ...
    return createPortal(
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0 z-toast flex flex-col gap-3 w-[calc(100%-32px)] md:w-full md:max-w-[400px] pointer-events-none">
