...
export default function OrdersTab() {
    ...
    if (loading) {
        return (
            <div>
                <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '20px', color: '#111827' }}>Mis Pedidos</h1>
                <div style={{ ...cardStyle, textAlign: 'center', padding: '48px', color: '#6B7280' }}>
            ...
            <div>
                ...
                <div style={{ ...cardStyle, textAlign: 'center', padding: '48px 24px' }}>
                    ...
                    <button
                        ...
                        style={{
                            backgroundColor: '#DC2626', color: 'white', padding: '10px 24px',
                            borderRadius: '8px', border: 'none', fontWeight: 'bold', fontSize: '14px', cursor: 'pointer',
                        }}
                    >
                        Ver menú
                    </button>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
                        <div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '4px' }}>
                                <h3 style={{ fontSize: '16px', fontWeight: 'bold', margin: 0, color: '#111827' }}>
                        ...
                        <div style={{ textAlign: 'right' }}>
                            ...
                            <div style={{ fontSize: '12px', color: '#6B7280' }}>
                                {order.items?.reduce((s: number, i: any) => s + i.quantity, 0) ?? 0} productos
                            </div>
                        </div>
                    </div>
                    ...
                    {order.status !== 'delivered' && order.status !== 'cancelled' && (
                        <button
                            ...
                            style={{
                                ...
                                cursor: 'pointer', backgroundColor: '#10B981', color: 'white',
                                fontSize: '13px', fontWeight: 'bold', width: 'fit-content'
                            }}
                        >
