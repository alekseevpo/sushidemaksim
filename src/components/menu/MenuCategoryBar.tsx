    ...
    return (
        <aside className="hidden lg:block w-[220px] flex-shrink-0 bg-red-600 min-h-full z-30">
            <div className="sticky top-[64px] h-[calc(100vh-64px)] pb-8 px-3 flex flex-col items-stretch overflow-y-auto no-scrollbar rounded-none">
                ...
                <div className="mt-auto px-4 flex flex-col items-stretch gap-6 pb-8">
                    <button
                        onClick={() => {
                            window.dispatchEvent(new CustomEvent('open:reservation'));
                        }}
                        className="w-full bg-white text-red-600 border-none rounded-2xl py-4.5 px-2 font-black text-[13px] tracking-[0.1em] transition-all duration-300 cursor-pointer flex items-center justify-center gap-3 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.2)] hover:shadow-[0_15px_35px_-5px_rgba(0,0,0,0.3)] hover:-translate-y-1 active:scale-[0.97] group"
                    >
                        <svg
                            viewBox="0 0 24 24"
                            width="20"
                    ...
                    <div className="flex items-center justify-center pointer-events-none select-none opacity-40">
